...
public class Main {
    public static void main(String[] args) {
        ...
        Calculator calculator = new Calculator();               //Object calculator
        char choose;

        do {                                                    //Do - While loop to do calculation
            ...
            calculator.calculateResult(a, b, symbol);           //Method calling using object
